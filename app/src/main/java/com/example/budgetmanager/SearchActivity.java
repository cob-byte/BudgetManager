...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {String uid = mUser.getUid();
            ...
            mref = FirebaseDatabase.getInstance().getReference().child("budget").child(uid);
        }
    ...
    private void populateSearch(DataSnapshot snapshot) {
        ...
        Log.d("budget","Reading Data");
        ArrayList<String> names=new ArrayList<>();

        if(snapshot.exists()){
            for(DataSnapshot ds:snapshot.getChildren()){
                Data data=ds.getValue(Data.class);
                String name=data.getItem();
    ...
    private void searchType(String name) {
        ...
        Query query=mref.orderByChild("item").equalTo(name);
